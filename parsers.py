...
def parse(list_of_filepaths, settings):
    ...
    for filename_list_index, conformer in enumerate(list_of_filepaths_by_conformer):
        ...
        if sp_calc_details:
            ...
            sp_functional_and_basis_set = sp_functional_and_basis_set.replace("wB97", "ωB97")
        ...
        if opt_calc_details:
            ...
            opt_functional_and_basis_set = opt_functional_and_basis_set.replace("wB97", "ωB97")
        ...
        if tddft_calc_details:
            ...
            tddft_functional_and_basis_set = tddft_functional_and_basis_set.replace("wB97", "ωB97")
        ...
        if nmr_calc_details:
            ...
            nmr_functional_and_basis_set = nmr_functional_and_basis_set.replace("wB97", "ωB97")
        ...
        if gaussian:
            ...
            if or_calc_details:
                ...
                or_functional_and_basis_set = or_functional_and_basis_set.replace("wB97", "ωB97")
    ...
    if (
        ...
        parser_error_check = "Error detected"
        error_message = (
            "Inequal amounts of opt vs. freq data were extracted for conformers\n"
    ...
    if (
        ...
        parser_error_check = "Error detected"
        error_message = (
            "Inequal amounts of energies vs. coordinates data were extracted for\n"
    ...
    if (
            ...
            and settings["NMR/ECD/VCD table"] is False
        ...
        for conf_number_a, element in enumerate(elements):
            ...
            for conf_number_b in range(number_of_confs):
                ...
                if conf_number_a < conf_number_b:
                    coords_a = [elements[conf_number_a], x_coords[conf_number_a],
                                y_coords[conf_number_a], z_coords[conf_number_a]]
                    coords_b = [elements[conf_number_b], x_coords[conf_number_b],
                                y_coords[conf_number_b], z_coords[conf_number_b]]
